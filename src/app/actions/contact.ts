...
/**
 * Escape before interpolating into the notification email. Every value here is
 * attacker-controllable — anyone can type into the form, and since an AI
 * assistant can now draft one (see `lib/agent/lead-draft.ts`), the text may
 * have been composed by a model working from content we do not control.
 * Aparna's inbox should render a lead as text, never as markup.
 */
      ...
      body: JSON.stringify({
        ...
        html: `
          ...
          <table style="border-collapse:collapse;width:100%;max-width:500px;">
            ...
            <tr><td style="padding:8px;border-bottom:1px solid #eee;font-weight:bold;">Email</td><td style="padding:8px;border-bottom:1px solid #eee;"><a href="mailto:${encodeURIComponent(email)}">${escapeHtml(email)}</a></td></tr>
            <tr><td style="padding:8px;border-bottom:1px solid #eee;font-weight:bold;">Phone</td><td style="padding:8px;border-bottom:1px solid #eee;"><a href="tel:${encodeURIComponent(phone)}">${escapeHtml(phone) || "Not provided"}</a></td></tr>
            <tr><td style="padding:8px;border-bottom:1px solid #eee;font-weight:bold;">Interest</td><td style="padding:8px;border-bottom:1px solid #eee;">${escapeHtml(interest) || "Not specified"}</td></tr>
            <tr><td style="padding:8px;border-bottom:1px solid #eee;font-weight:bold;">Source</td><td style="padding:8px;border-bottom:1px solid #eee;">${escapeHtml(source || "Contact Form")}</td></tr>
            ${message ? `<tr><td style="padding:8px;border-bottom:1px solid #eee;font-weight:bold;">Message</td><td style="padding:8px;border-bottom:1px solid #eee;">${escapeHtml(message)}</td></tr>` : ""}
          </table>
...
export async function submitChatLead(data: ChatLeadData) {
  ...
  const detailRows = details
    .map(
      (d) =>
        `<tr><td style="padding:8px;border-bottom:1px solid #eee;font-weight:bold;color:#555;">${d.label}</td><td style="padding:8px;border-bottom:1px solid #eee;">${escapeHtml(d.value)}</td></tr>`,
    )
    .join("");
    ...
    <div style="font-family:sans-serif;max-width:600px;">
      ...
      <div style="padding:20px;border:1px solid #e5e5e5;border-top:none;border-radius:0 0 8px 8px;">
        <div style="background:#f0fdfa;border-left:4px solid #14b8a6;padding:12px 16px;margin-bottom:20px;border-radius:4px;">
          <p style="margin:0;font-size:14px;color:#134e4a;"><strong>Chat Summary:</strong> ${escapeHtml(summary)}</p>
        </div>
        ...
        <table style="border-collapse:collapse;width:100%;">
          <tr><td style="padding:8px;border-bottom:1px solid #eee;font-weight:bold;">Name</td><td style="padding:8px;border-bottom:1px solid #eee;">${escapeHtml(name)}</td></tr>
          ${phone ? `<tr><td style="padding:8px;border-bottom:1px solid #eee;font-weight:bold;">Phone</td><td style="padding:8px;border-bottom:1px solid #eee;"><a href="tel:${encodeURIComponent(phone)}">${escapeHtml(phone)}</a></td></tr>` : ""}
          ${email ? `<tr><td style="padding:8px;border-bottom:1px solid #eee;font-weight:bold;">Email</td><td style="padding:8px;border-bottom:1px solid #eee;"><a href="mailto:${encodeURIComponent(email)}">${escapeHtml(email)}</a></td></tr>` : ""}
        </table>
        ...
        html: `
          <div style="font-family:sans-serif;max-width:600px;">
            ...
            <div style="padding:20px;border:1px solid #e5e5e5;border-top:none;border-radius:0 0 8px 8px;">
              <table style="border-collapse:collapse;width:100%;">
                <tr><td style="padding:8px;border-bottom:1px solid #eee;font-weight:bold;">Name</td><td style="padding:8px;border-bottom:1px solid #eee;">${escapeHtml(name)}</td></tr>
                <tr><td style="padding:8px;border-bottom:1px solid #eee;font-weight:bold;">Phone</td><td style="padding:8px;border-bottom:1px solid #eee;"><a href="tel:${encodeURIComponent(phone)}">${escapeHtml(phone)}</a></td></tr>
                ${email ? `<tr><td style="padding:8px;border-bottom:1px solid #eee;font-weight:bold;">Email</td><td style="padding:8px;border-bottom:1px solid #eee;"><a href="mailto:${encodeURIComponent(email)}">${escapeHtml(email)}</a></td></tr>` : `<tr><td style="padding:8px;border-bottom:1px solid #eee;font-weight:bold;">Email</td><td style="padding:8px;border-bottom:1px solid #eee;">Not provided</td></tr>`}
                <tr><td style="padding:8px;border-bottom:1px solid #eee;font-weight:bold;">Working with a Realtor?</td><td style="padding:8px;border-bottom:1px solid #eee;">${hasRealtor ? `Yes${realtorName ? ` — ${escapeHtml(realtorName)}` : ""}` : "No"}</td></tr>
              </table>
