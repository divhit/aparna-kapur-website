    ...
    <>
      ...
      <section className="relative pt-28 pb-16 md:py-24">
        <div
          ...
          style={{
            backgroundImage:
              "url('/images/neighborhoods/dunbar-southlands.webp')",
          }}
        >
      ...
      <NeighbourhoodListings slug="dunbar-southlands" />
      ...
      <section className="bg-warm-50 border-y border-warm-100">
        <div className="max-w-4xl mx-auto px-6 py-10">
          <div className="grid grid-cols-3 gap-6 text-center">
            <div>
              <p className="font-serif text-2xl text-teal-700">{NEIGHBOURHOODS["dunbar-southlands"].avgPrice}</p>
