    ...
    <>
      ...
      <section className="relative pt-28 pb-16 md:py-24">
        <div
          ...
          style={{
            backgroundImage:
              "url('/images/neighborhoods/grandview-woodland.webp')",
          }}
        >
      ...
      <article className="py-16">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <p className="text-warm-700 leading-relaxed mb-6">
            Composite benchmark: around <strong>{NEIGHBOURHOODS["grandview-woodland"].avgPrice}</strong>, skewing
      ...
      <section className="bg-warm-50 border-y border-warm-100">
        <div className="max-w-4xl mx-auto px-6 py-10">
          <div className="grid grid-cols-3 gap-6 text-center">
            <div>
              <p className="font-serif text-2xl text-teal-700">{NEIGHBOURHOODS["grandview-woodland"].avgPrice}</p>
      ...
      />
      <MarketPriceLinks slug="grandview-woodland" />
    </>
  );
}
