...
export default async function HastingsSunrisePage() {
  ...
  return (
    <>
      ...
      <NeighbourhoodListings slug="hastings-sunrise" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
            ...
            <div className="lg:col-span-3">
              <div className="grid grid-cols-3 gap-6 max-w-2xl">
                <div>
                  <p className="font-serif text-2xl text-teal-700">{NEIGHBOURHOODS["hastings-sunrise"].avgPrice}</p>
      ...
      />
      <MarketPriceLinks slug="hastings-sunrise" />
    </>
  );
}
