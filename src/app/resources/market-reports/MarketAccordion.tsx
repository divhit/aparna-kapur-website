...
const monthlyData: MonthData[] = [
  {
    ...
    year: "2026",
    stats: [
      { label: "Composite Benchmark", value: "$1.10M", change: "-0.1% MoM" },
      { label: "Active Listings", value: "17,017", change: "-3.1% YoY" },
      { label: "New Listings", value: "5,938", change: "-6.0% YoY" },
      {
    ...
    neighbourhoods: [
      ...
      {
        name: "Marpole",
        detached: "$1.95M (benchmark)",
        townhome: "$1.48M (benchmark)",
      ...
      {
        name: "South Cambie",
        detached: "$4.02M (benchmark)",
        townhome: "$1.47M (benchmark)",
      ...
      {
        name: "Riley Park",
        detached: "$1.98M (benchmark)",
        townhome: "$1.15M (benchmark)",
        condo: "$953K (benchmark)",
        trend: "Improving",
        href: "/neighborhoods/riley-park",
      },
      {
        name: "Kerrisdale",
        detached: "$3.03M (benchmark)",
  ...
  },
  {
    ...
    year: "2026",
    stats: [
      { label: "Composite Benchmark", value: "$1.10M", change: "+0.2% MoM" },
      { label: "Active Listings", value: "16,917", change: "-1.0% YoY" },
      { label: "New Listings", value: "6,115", change: "-7.6% YoY" },
      {
        label: "Sales-to-Active Ratio",
        value: "13.1%",
        change: "Balanced Market",
    ...
    neighbourhoods: [
      ...
      {
        name: "Riley Park",
        detached: "$1.94M (benchmark)",
        townhome: "$1.16M (benchmark)",
        condo: "$958K (benchmark)",
        trend: "Stable",
        href: "/neighborhoods/riley-park",
      },
      {
        name: "Kerrisdale",
        detached: "$3.07M (benchmark)",
  ...
  },
  {
    ...
    neighbourhoods: [
      ...
      {
        name: "Marpole",
        detached: "$2.09M (proxy)",
        townhome: "$1.55M (proxy)",
        condo: "$709K (benchmark)",
        trend: "Stable",
        href: "/neighborhoods/marpole",
      },
      {
        name: "South Cambie",
        detached: "$4.06M (benchmark)",
        townhome: "$1.46M (benchmark)",
