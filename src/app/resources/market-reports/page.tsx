      ...
      <section className="bg-teal-950 py-20">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-white/70 max-w-xl mx-auto">
            Data-driven insights on the Vancouver real estate market, with a
            focus on Oakridge and surrounding neighborhoods.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-sm border border-warm-100 mb-12">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-6">
              {[
                { label: "Median Home Price", value: "$1.6M", change: "+3.2%" },
                { label: "Active Listings", value: "5,400+", change: "+12%" },
                {
