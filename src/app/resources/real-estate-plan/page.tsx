      ...
      <section className="py-20">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <p className="text-warm-600 leading-relaxed mb-12">
            I believe in starting with a plan. A simple, honest conversation about where you are, where you want to be, and how real estate fits into the picture. No jargon, no pressure &mdash; just clarity.
          </p>
          ...
          <div className="border-t border-warm-100 pt-12 mb-12">
            ...
            <p className="text-warm-600 leading-relaxed">
              If you are a first-time buyer, I will also walk you through every program and incentive available to you &mdash; the FHSA, HBP, PTT exemptions, and more. Most buyers leave money on the table simply because they do not know what is available.
            </p>
          </div>
          ...
          <div className="border-t border-warm-100 pt-12 mb-12">
            ...
            <p className="text-warm-600 leading-relaxed">
              I will give you a clear Comparative Market Analysis and an honest assessment of what your home is worth today. Not inflated to win your listing &mdash; accurate, so we price it right and sell it well.
            </p>
          </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-teal-800/80 leading-relaxed italic">
                  &ldquo;Every good real estate decision starts with a conversation. Tell me what you are thinking about &mdash; buying, selling, investing, or just exploring &mdash; and I will give you an honest assessment of where you stand and what your options are. No cost, no commitment.&rdquo;
                </p>
              </div>
            </div>
          </div>
