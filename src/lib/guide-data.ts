...
export const buyingGuideSteps: GuideStep[] = [
  {
    ...
    insight:
      "I always start with a real conversation about what home means to you. Not what you think you should be looking for, but what actually matters in your life right now and in the next five to ten years. That clarity changes everything.",
  },
  {
  ...
  },
  {
    ...
    content: [
      ...
      "A lot can happen between the draft of the first contract and the final push that closes the transaction, so what systems are in place to make sure that you are protected through this process?\n\nFinally, look for someone you can relate to, someone who asks the right questions and gets you thinking critically and effectively about your buying needs.",
    ],
    insight:
